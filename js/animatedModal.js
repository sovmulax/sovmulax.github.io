              ...
              a('html')
                ...
                .css(
                  ...
                  ((n = a('<div>')
                    ...
                    .appendTo('body')),
                  (t = a('<div>').css({ width: '100%' }).appendTo(n).outerWidth()),
                  n.remove(),
                  100 - t)
                ),
    ...
    s.css(r),
        ...
        a.preventDefault(),
          d == l &&
            (s.hasClass(e.modalTarget + '-off') &&
              (s.removeClass(e.animatedOut), s.removeClass(e.modalTarget + '-off'), s.addClass(e.modalTarget + '-on')),
      ...
      i.click(function (a) {
        a.preventDefault(),
          e.beforeClose(),
          s.hasClass(e.modalTarget + '-on') &&
            (s.removeClass(e.modalTarget + '-on'), s.addClass(e.modalTarget + '-off')),
          s.hasClass(e.modalTarget + '-off') &&
