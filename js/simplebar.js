    ...
    return (
      (e.init = function () {
        (this.el.SimpleBar = this),
          nr && (this.initDOM(), (this.scrollbarWidth = sr()), this.recalculate(), this.initListeners());
      }),
      (e.initDOM = function () {
        var t = this;
        if (
      ...
      (e.hideNativeScrollbar = function () {
        if (
          ...
          (this.contentWrapperEl.style[t] =
            this.axis.y.isOverflowing || this.axis.y.forceVisible ? this.minScrollbarWidth + 'px' : 0),
