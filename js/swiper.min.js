...
!(function (e, t) {
        ...
        for (var S, M = e.slidesPerColumn, P = E / M, z = Math.floor(h / e.slidesPerColumn), k = 0; k < h; k += 1) {
          ...
          if (e.slidesPerColumn > 1) {
            ...
            if ('row' === e.slidesPerColumnFill && e.slidesPerGroup > 1) {
              ...
              (L =
                (I = A - (D = Math.floor(A / e.slidesPerGroup)) * e.slidesPerGroup + O * e.slidesPerGroup) +
                (D * E) / M),
                $.css({
  ...
  var f = {
    setGrabCursor: function (e) {
      if (
        !(o.touch || !this.params.simulateTouch || (this.params.watchOverflow && this.isLocked) || this.params.cssMode)
      ) {
        var t = this.el;
        (t.style.cursor = 'move'),
      ...
      if (!i.isTouchEvent || 'mousemove' !== l.type) {
        ...
        if (!this.allowTouchMove)
          return (
            ...
            void (
              i.isTouched &&
              (n.extend(r, { startX: h, startY: p, currentX: h, currentY: p }), (i.touchStartTime = n.now()))
            )
          );
              ...
              if (
                ...
                f > 0 && i.currentTranslate > this.minTranslate()
                  ? ((m = !1),
                    a.resistance &&
                      (i.currentTranslate =
                        this.minTranslate() - 1 + Math.pow(-this.minTranslate() + i.startTranslate + f, g)))
                  : f < 0 &&
                    i.currentTranslate < this.maxTranslate() &&
                    ((m = !1),
                    a.resistance &&
                      (i.currentTranslate =
                        this.maxTranslate() + 1 - Math.pow(this.maxTranslate() - i.startTranslate - f, g))),
      ...
      if (s.freeMode) {
        ...
        for (var P = 0, z = t.slidesSizesGrid[0], k = 0; k < l.length; k += s.slidesPerGroup)
          void 0 !== l[k + s.slidesPerGroup]
            ? p >= l[k] && p < l[k + s.slidesPerGroup] && ((P = k), (z = l[k + s.slidesPerGroup] - l[k]))
        ...
        if ((a = c[0])) {
          ...
          return (
            ...
            n.extend(h, {
              ...
              rtlTranslate:
                'horizontal' === h.params.direction && ('rtl' === a.dir.toLowerCase() || 'rtl' === c.css('direction')),
    ...
    Q = {
      update: function (e) {
        ...
        if (e) t.$wrapperEl.find('.' + t.params.slideClass).remove();
          ...
          for (var P = p; P <= c; P += 1)
            (P < x || P > T) &&
              t.$wrapperEl.find('.' + t.params.slideClass + '[data-swiper-slide-index="' + P + '"]').remove();
    ...
    re = {
      ...
      setDragPosition: function (e) {
        var t,
          ...
          o = i.dragStartPos;
        (t =
          (i.getPointerPosition(e) - a.offset()[this.isHorizontal() ? 'left' : 'top'] - (null !== o ? o : r / 2)) /
          (n - r)),
      ...
      setTranslate: function () {
        ...
        for (var u = 0; u < a.length; u += 1) {
          ...
          var T =
            ...
            'px)';
          if (
            (b <= 1 && b > -1 && ((c = 90 * f + 90 * b), o && (c = 90 * -f - 90 * b)), v.transform(T), d.slideShadows)
          ) {
            var E = h ? v.find('.swiper-slide-shadow-left') : v.find('.swiper-slide-shadow-top'),
              C = h ? v.find('.swiper-slide-shadow-right') : v.find('.swiper-slide-shadow-bottom');
            0 === E.length &&
              ((E = s('<div class="swiper-slide-shadow-' + (h ? 'left' : 'top') + '"></div>')), v.append(E)),
              0 === C.length &&
                ((C = s('<div class="swiper-slide-shadow-' + (h ? 'right' : 'bottom') + '"></div>')), v.append(C)),
      ...
      setTranslate: function () {
        for (var e = this.slides, t = this.rtlTranslate, i = 0; i < e.length; i += 1) {
          ...
          if (
            ...
            0 === h.length &&
              ((h = s('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? 'left' : 'top') + '"></div>')),
              a.append(h)),
              0 === p.length &&
                ((p = s('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? 'right' : 'bottom') + '"></div>')),
                a.append(p)),
      ...
      setTranslate: function () {
        for (
          ...
          if ((f.transform(E), (f[0].style.zIndex = 1 - Math.abs(Math.round(g))), n.slideShadows)) {
            ...
            0 === C.length &&
              ((C = s('<div class="swiper-slide-shadow-' + (l ? 'left' : 'top') + '"></div>')), f.append(C)),
              0 === S.length &&
                ((S = s('<div class="swiper-slide-shadow-' + (l ? 'right' : 'bottom') + '"></div>')), f.append(S)),
      ...
      onThumbClick: function () {
        ...
        if (e) {
          ...
          if (!((i && s(i).hasClass(this.params.thumbs.slideThumbActiveClass)) || null == t)) {
            var a;
            if (
              ((a = e.params.loop ? parseInt(s(e.clickedSlide).attr('data-swiper-slide-index'), 10) : t),
              this.params.loop)
            ) {
